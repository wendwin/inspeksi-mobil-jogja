export default function Service() {
    return (
        <section className="container px-4 md:px-0 mx-auto my-5 md:my-10">
            ...
            <div className="py-5 md:py-10 flex flex-wrap gap-5">
                <div className="card bg-base-100 shadow-lg max-w-50 mx-auto md:max-w-75 ">
                    <div className="card-body border-gray-300 border-1 bg-white text-center rounded-xl py-5 px-2 md:min-h-100">
                        ...
                        <button className="uppercase rounded-lg bg-amber-500 p-3 font-medium text-sm text-black poin md:text-lg transform transition-all duration-200 hover:scale-105 hover:bg-amber-900 hover:text-white">Booking Sekarang</button>
