export default function Trusted() {
    return (
        <section className="mt-24 mb-20  md:mb-18 lg:mt-28 text-center">
            <p className="text-lg my-3 bg-white text-[#192459] text-center font-bold md:text-2xl md:my-5">Mengapa CekAuto.id?</p>
            <div className="max-w-6xl mx-auto mb-10 p-5">
                <h2 className="text-lg md:text-2xl font-semibold text-black mb-2 text-center">Jangan Sampai Salah Beli Mobil Bekas.</h2>
                <p className="text-justify md:text-center max-w-3xl mx-auto">Di balik bodi mulus, bisa tersembunyi banyak masalah. Dengan tim mekanik berpengalaman, <span className="font-bold">CekAuto.id</span> membantu Anda mengetahui kondisi sebenarnya mobil incaran Anda sebelum menyesal kemudian.</p>
            </div>
